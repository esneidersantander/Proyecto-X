 ...
 -->
      ...
      <div class="container">
        ...
        <div class="large-12 large-offset-1 columns page-hero__copy">
          <h1 class="header-medium sw-page-hero__heading">Startup Weekend Manabí Agrotech</h1>
     ...
     --> <br><br>
        ...
        <form role="form" method="post" action="{{url('/registrar/ingresar')}}">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="combobox form-control" name="sexo" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="combobox form-control" name="decidisteparticipar" required>
          ...
          <div class="form-group row">
            <label for="inputPassword" class="col-sm-2 col-form-label">¿Te gustaría estar informado acerca de tu
              comunidad local a través de Startup Digest de tu comunidad?:</label>
            <div class="col-sm-10">
              <select class="combobox form-control" name="estarinformadocomunidad" required>
          ...
          <div class="form-group row">
            <label for="inputPassword" class="col-sm-2 col-form-label">¿Te gustaría estar informado acerca de la
              comunidad de Techstars Startup Weekend a través de nuestro boletín electrónico?:</label>
            <div class="col-sm-10">
              <select class="combobox form-control" name="estarinformadoboletin" required>
                <option value="" selected="selected">Seleccionar</option>
                <option value="1">SI</option>
                <option value="2">NO</option>
